...
public class EnterInstructorID extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = getString(R.string.url) + "instructorRecord.php";
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    //if (status.equals("true") && enteredID.equals(id)) {
                                        ...
                                        editor.apply();
                                        Intent intent = new Intent(getApplicationContext(), InstructorRecord.class);
